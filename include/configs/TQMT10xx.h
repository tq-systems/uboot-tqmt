...
/* NOR Flash Timing Params 600 MHz Platform Clock*/
#define CONFIG_SYS_NOR_FTIM0_600	(FTIM0_NOR_TACSE(0x1) | \
					FTIM0_NOR_TEADC(0x4) | \
					FTIM0_NOR_TEAHC(0x3))
#define CONFIG_SYS_NOR_FTIM1_600	(FTIM1_NOR_TACO(0x1) | \
					FTIM1_NOR_TRAD_NOR(0x27) |\
					FTIM1_NOR_TSEQRAD_NOR(0x00))
#define CONFIG_SYS_NOR_FTIM2_600	(FTIM2_NOR_TCS(0x1) | \
					FTIM2_NOR_TCH(0x1) | \
					FTIM2_NOR_TWPH(0x00) | \
					FTIM2_NOR_TWP(0x21))
#define CONFIG_SYS_NOR_FTIM3_600	0x0

/* NOR Flash Timing Params 400 MHz Platform Clock*/
#define CONFIG_SYS_NOR_FTIM0_400	(FTIM0_NOR_TACSE(0x1) | \
					FTIM0_NOR_TEADC(0x3) | \
					FTIM0_NOR_TEAHC(0x2))
#define CONFIG_SYS_NOR_FTIM1_400	(FTIM1_NOR_TACO(0x1) | \
					FTIM1_NOR_TRAD_NOR(0x1a) |\
					FTIM1_NOR_TSEQRAD_NOR(0x00))
#define CONFIG_SYS_NOR_FTIM2_400	(FTIM2_NOR_TCS(0x1) | \
					FTIM2_NOR_TCH(0x1) | \
					FTIM2_NOR_TWPH(0x00) | \
					FTIM2_NOR_TWP(0x15))
#define CONFIG_SYS_NOR_FTIM3_400	0x0
